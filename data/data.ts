export const lensMetricsData = [
  {
    ...
    metrics: [
      ...
      { key: "bestTradePnL", label: "Best Trade P&L", show: true },
      { key: "worstTradePnL", label: "Worst Trade P&L", show: true },
      ...
      { key: "monthlyReturn", label: "Monthly Return", show: true },
      { key: "dailyReturn", label: "Daily Return", show: true },
...

  {
    ...
    metrics: [
      ...
      { key: "averageLoss", label: "Average Loss", show: true },
      { key: "largestWin", label: "Largest Win", show: true },
      { key: "largestLoss", label: "Largest Loss", show: true },
      { key: "smallestWin", label: "Smallest Win", show: false },
      { key: "smallestLoss", label: "Smallest Loss", show: true },
